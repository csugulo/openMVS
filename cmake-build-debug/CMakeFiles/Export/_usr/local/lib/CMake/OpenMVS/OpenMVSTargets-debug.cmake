...
set_target_properties(Common PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/OpenMVS/libCommon.a"
  )
...
set_target_properties(Math PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/OpenMVS/libMath.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS Math )
list(APPEND _IMPORT_CHECK_FILES_FOR_Math "/usr/local/lib/OpenMVS/libMath.a" )

# Import target "IO" for configuration "Debug"
set_property(TARGET IO APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(IO PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/OpenMVS/libIO.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS IO )
list(APPEND _IMPORT_CHECK_FILES_FOR_IO "/usr/local/lib/OpenMVS/libIO.a" )

# Import target "MVS" for configuration "Debug"
set_property(TARGET MVS APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(MVS PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/OpenMVS/libMVS.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS MVS )
list(APPEND _IMPORT_CHECK_FILES_FOR_MVS "/usr/local/lib/OpenMVS/libMVS.a" )

# Import target "InterfaceVisualSFM" for configuration "Debug"
set_property(TARGET InterfaceVisualSFM APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(InterfaceVisualSFM PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/OpenMVS/InterfaceVisualSFM"
  )
...
# Import target "DensifyPointCloud" for configuration "Debug"
set_property(TARGET DensifyPointCloud APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(DensifyPointCloud PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/OpenMVS/DensifyPointCloud"
  )
...
# Import target "ReconstructMesh" for configuration "Debug"
set_property(TARGET ReconstructMesh APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(ReconstructMesh PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/OpenMVS/ReconstructMesh"
  )
...
# Import target "RefineMesh" for configuration "Debug"
set_property(TARGET RefineMesh APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(RefineMesh PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/OpenMVS/RefineMesh"
  )
...
# Import target "TextureMesh" for configuration "Debug"
set_property(TARGET TextureMesh APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(TextureMesh PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/OpenMVS/TextureMesh"
  )
